    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->pushButton_umnoj, SIGNAL(clicked()),this, SLOT(math_operations()));
    connect(ui->pushButton_delenie, SIGNAL(clicked()),this, SLOT(math_operations()));

    ui->pushButton_plus->setCheckable(true);
    ui->pushButton_minus->setCheckable(true);
    ui->pushButton_umnoj->setCheckable(true);
...
void MainWindow::on_pushButton_AC_clicked()
{
    ...
    ui->pushButton_umnoj->setChecked(false);
...
void MainWindow::on_pushButton_sum_clicked()
{
    ...
    }else if(ui->pushButton_umnoj->isChecked()){
